...
<div class="service-form-page">
    ...
    <div class="service-form-header">
        ...
        <p>
            Tambahkan galeri foto baru ke dalam website.
        </p>
    ...
    <div class="service-form-card">
        ...
        <div class="form-card-header">
            ...
            <h3>Informasi Foto Galeri</h3>

            <p>
                Isi informasi foto galeri yang ingin ditampilkan kepada pelanggan.
            </p>
        ...
        >
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    class="form-control"
                    value="{{ old('title') }}"
                    placeholder="Contoh : Jok Mobil Avanza"
                    required>
