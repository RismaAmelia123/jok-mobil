...
<div class="services-page">
    ...
    <div class="services-header">
        ...
        <div class="services-header-left">
            ...
            <p>
                Kelola galeri yang ditampilkan pada website.
            </p>

        </div>

        <a href="{{ route('admin.galleries.create') }}" class="btn-add-service">
    ...
    $activeGallery = $galleries->where('is_active', true)->count();
    $inactiveGallery = $galleries->where('is_active', false)->count();
    @endphp
