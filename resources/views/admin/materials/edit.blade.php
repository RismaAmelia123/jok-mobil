...
@section('title', 'Edit Bahan Interior')
...
<div class="service-form-page">
    ...
    <div class="service-form-header">
        ...
        <h1>Edit Bahan Interior</h1>

        <p>
            Perbarui informasi bahan interior mobil.
        </p>
    ...
    <div class="service-form-card">
        ...
        <div class="form-card-header">
            ...
            <p>
                Ubah informasi bahan sesuai kebutuhan.
            </p>
