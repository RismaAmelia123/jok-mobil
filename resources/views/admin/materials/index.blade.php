...
<div class="services-page">
    ...
    <div class="services-header">
        ...
        <div class="services-header-left">
            ...
            <h1>Bahan Interior</h1>

            <p>
                Kelola bahan interior mobil yang ditampilkan pada website.
            </p>

        </div>

        <a href="{{ route('admin.materials.create') }}" class="btn-add-service">
            <i class="fas fa-plus"></i>
            Tambah Bahan Interior
        </a>
    ...
    $inactiveMaterials = $materials->where('is_active', false)->count();
    @endphp
    ...
    <div class="services-card">
        ...
        <div class="services-card-header">
            ...
            <div class="services-card-title">
                ...
                <h3>Daftar Bahan Interior</h3>

                <p>
                    Daftar bahan interior beserta harga yang tersedia.
                </p>
        ...
        @else
            ...
            <div class="service-empty">
                ...
                <h3>Belum ada bahan interior</h3>

                <p>
                    Belum ada bahan interior yang ditambahkan.
                </p>
