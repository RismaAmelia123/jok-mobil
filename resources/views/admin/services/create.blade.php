...
<div class="service-form-page">
    ...
    <div class="service-form-header">
        ...
        <p>
            Tambahkan layanan interior mobil baru ke dalam website.
        </p>
    ...
    <div class="service-form-card">
        ...
        <div class="form-card-header">
            ...
            <p>
                Isi informasi layanan yang ingin ditampilkan kepada pelanggan.
            </p>
        ...
        >
            ...
            <div class="form-group">
                ...
                <textarea
                    ...
                    name="description"
                    class="form-control"
                    placeholder="Jelaskan mengenai layanan ini..."
                >{{ old('description') }}</textarea>

                <div class="form-help">
                    Deskripsi akan digunakan untuk menjelaskan layanan kepada pelanggan.
                </div>
